...
@AlgorithmManager.evaluator_for(CofConfigurator)
@Inject
class Cof(AlgorithmEvaluate):
    """
    ...
    def __init__(
        ...
        """
        Initializes the COF evaluator with the provided services.
    ...
    def evaluate(self, data: CofConfigurator):
        """
        ...
        algorithm_instance: COF = self.pyod_service.loadModel(data.model_name)
